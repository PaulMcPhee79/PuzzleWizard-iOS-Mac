...
#ifdef UI_DEVICE_HARDWARE_ALLOWED
...
- (NSUInteger) platformType
{
    ...
    //if ([UIScreen mainScreen] && [UIScreen mainScreen].scale == 2.0f && [[UIScreen mainScreen] bounds].size.height == 568.0f)
    ...
    if ([platform hasPrefix:@"iPad2"])              return UIDevice2GiPad; // Or iPad mini 1G, which should perform comparatively and have the same screen resolutions.
