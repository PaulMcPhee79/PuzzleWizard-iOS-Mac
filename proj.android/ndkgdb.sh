...
#APPNAME="PuzzleHound"
APP_ANDROID_NAME="com.cheekymammoth.puzzlewizard"
...
# ... use paths relative to current directory
    ...
    APP_ROOT="$COCOS2DX_ROOT/samples/Cpp/$APPNAME"
    APP_ANDROID_ROOT="$COCOS2DX_ROOT/samples/Cpp/$APPNAME/proj.android"
fi
